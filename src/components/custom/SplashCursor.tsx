...
function SplashCursor() {
  ...
  useEffect(() => {
    ...
    function getWebGLContext(cnv: HTMLCanvasElement) {
      ...
      let glCtx = cnv.getContext('webgl2', params) as WebGL2RenderingContext | null;
      const isWebGL2 = !!glCtx;
      if (!isWebGL2) {
        glCtx = (cnv.getContext('webgl', params) || cnv.getContext('experimental-webgl', params)) as WebGL2RenderingContext | null;
      }
      ...
      const halfFloatTexType = isWebGL2 ? glCtx.HALF_FLOAT : (halfFloat ? halfFloat.HALF_FLOAT_OES : null);
    ...
    function getSupportedFormat(glCtx: WebGL2RenderingContext, internalFormat: number, format: number, type: number) {
    ...
    function updateKeywords() {
      ...
      displayMaterial.bind(...displayKeywords);
    }
